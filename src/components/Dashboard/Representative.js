  ...
  return(
    <div>
      <Card className = {classes.root}>
        ...
        <CardActionArea>
          <CardMedia className = {classes.media} component = "img" src = {dets.photoUrl} title = "beto"/>
        </CardActionArea>
        ...
        <CardContent>
          ...
          <p>Mailing: {dets.address[0].line1} {dets.address[0].city}, {dets.address[0].state}, {dets.address[0].zip}</p>
        </CardContent>
