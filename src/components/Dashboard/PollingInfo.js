...
class PollingInfo extends React.Component {
  ...
  localJurInfo = () => {
    ...
    if (this.state.localJur) {
      electionAdmin = Object.assign(
        {},
        this.state.localJur.electionAdministrationBody
      );
      address = Object.assign({}, electionAdmin.physicalAddress);
      return (
        <div className="pollingInfo">
  ...
  electionAdmin = () => {
    ...
    } = this.state.electionAdmin;
    let address = Object.assign({}, correspondenceAddress);
    return (
      <div className="pollingInfo">
        <a href={ballotInfoUrl} target="_blank" rel="noopener noreferrer">
          <Button>Ballot information</Button>
        </a>
        <a href={electionInfoUrl} target="_blank" rel="noopener noreferrer">
          <Button>Election Information</Button>
        </a>
        <a
          href={votingLocationFinderUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
          <Button>Voting location</Button>
        </a>
        <h5>Address: </h5>
        <p>
